...
[![](https://goreportcard.com/badge/zhuochengs/goxorm/builder)](https://goreportcard.com/report/zhuochengs/goxorm/builder)

Package builder is a lightweight and fast SQL builder for Go and XORM.

Make sure you have installed Go 1.1+ and then:

    go get zhuochengs/goxorm/builder
...
```Go
import . "zhuochengs/goxorm/builder"
